...
Public Class FrmMain
        ...
        Try
            If LoadImagesStr = False Then
                ...
                If Data > 0 Then
                    ...
                    'DataGridView1.Columns(2).DefaultCellStyle.Format = "ksh"
    ...
    Private Sub ButtonClearSelectedandImagePriview_Click(sender As Object, e As EventArgs) Handles ButtonClearSelectedandImagePriview.Click
        DataGridView1.ClearSelection()
        PictureBoxImagePreview.Image = Nothing
    End Sub
    ...
    Private Sub MakeSaleBtn_Click(sender As Object, e As EventArgs) Handles MakeSaleBtn.Click
        saleform.show()
    End Sub
